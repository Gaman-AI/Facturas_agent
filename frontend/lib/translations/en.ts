...
const en: Translations = {
  ...
  'upload.vendorSelection': 'Vendor Selection',
  'upload.selectVendor': 'Select a vendor',
  'upload.otherVendor': 'Others',
  'upload.customVendorUrl': 'Custom Vendor URL',
  'upload.selectedUrl': 'Selected URL:',
  'upload.vendorSelectionRequired': 'Please select a vendor',
  ...
  'browser.localModeDescription': 'Task will run on your local machine using your system browser. No live view available, but execution is typically faster.',
  ...
  // Ticket History
  'history.title': 'Ticket History',
  'history.subtitle': 'View and manage your uploaded tickets',
  'history.backToDashboard': 'Back to Dashboard',
  'history.loadingTickets': 'Loading tickets...',
  'history.errorLoading': 'Error loading tickets',
  'history.tryAgain': 'Try Again',
  'history.searchPlaceholder': 'Search tickets by file name, comercio, or ticket ID...',
  ...
  'history.noTicketsFound': 'No tickets found',
  'history.noTicketsMatch': 'No tickets match your current filters',
  'history.uploadFirst': 'Upload your first ticket to get started',
  'history.unknownStore': 'Unknown Store',
  ...
  'history.imageNotAvailable': 'Image not available for this ticket.',
  'history.ticketDetails': 'Ticket Details',
  ...
  'history.storeBranchPlaza': 'Store/Branch/Plaza',
  'history.paymentType': 'Payment Type',
  'history.tcNumber': 'TC Number',
  'history.trNumber': 'TR Number',
  'history.folVta': 'Fol Vta',
  'history.registerStationTerminal': 'Register Station Terminal',
  'history.cardLast4Digits': 'Card Last 4 Digits',
  'history.previous': 'Previous',
  'history.next': 'Next',
  'history.pageOf': 'Page {current} of {total}',
  'history.ticketImage': 'Ticket Image',
  'history.noImageAvailable': 'No image available',
  'history.noImageDescription': 'This ticket was uploaded before the image storage feature was implemented. Please upload a new ticket to view the image.',
  'history.noImageTooltip': 'No image available for this ticket'
}
