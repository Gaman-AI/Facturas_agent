...
const es: Translations = {
  ...
  'browser.localModeDescription': 'La tarea se ejecutará en tu máquina local usando el navegador de tu sistema. No hay vista en vivo disponible, pero la ejecución es típicamente más rápida.',
  ...
  // Ticket History
  'history.title': 'Historial de Tickets',
  'history.subtitle': 'Ver y administrar tus tickets subidos',
  'history.backToDashboard': 'Volver al Panel',
  'history.loadingTickets': 'Cargando tickets...',
  'history.errorLoading': 'Error al cargar tickets',
  'history.tryAgain': 'Intentar de Nuevo',
  'history.searchPlaceholder': 'Buscar tickets por nombre de archivo, comercio o ID de ticket...',
  ...
  'history.status.processed': 'Procesado',
  'history.status.failed': 'Fallido',
  'history.status.archived': 'Archivado',
  'history.noTicketsFound': 'No se encontraron tickets',
  'history.noTicketsMatch': 'Ningún ticket coincide con tus filtros actuales',
  'history.uploadFirst': 'Sube tu primer ticket para comenzar',
  'history.unknownStore': 'Tienda Desconocida',
  'history.ticketId': 'ID de Ticket',
  'history.total': 'Total',
  'history.date': 'Fecha',
  'history.uploaded': 'Subido',
  'history.viewDetails': 'Ver Detalles',
  'history.viewTicket': 'Ver Ticket',
  'history.imageNotAvailable': 'Imagen no disponible para este ticket.',
  'history.ticketDetails': 'Detalles del Ticket',
  'history.fileName': 'Nombre del Archivo',
  'history.status': 'Estado',
  'history.comercio': 'Comercio',
  'history.errorMessage': 'Mensaje de Error',
  'history.additionalDetails': 'Detalles Adicionales',
  'history.mesaFolio': 'Mesa Folio',
  'history.idTicket': 'ID Ticket',
  'history.storeBranchPlaza': 'Tienda/Sucursal/Plaza',
  'history.paymentType': 'Tipo de Pago',
  'history.tcNumber': 'Número TC',
  'history.trNumber': 'Número TR',
  'history.folVta': 'Fol Vta',
  'history.registerStationTerminal': 'Registro Estación Terminal',
  'history.cardLast4Digits': 'Últimos 4 Dígitos de la Tarjeta',
  'history.previous': 'Anterior',
  'history.next': 'Siguiente',
  'history.pageOf': 'Página {current} de {total}',
  'history.ticketImage': 'Imagen del Ticket',
  'history.noImageAvailable': 'No hay imagen disponible',
  'history.noImageDescription': 'Este ticket fue subido antes de que se implementara la función de almacenamiento de imágenes. Por favor, sube un nuevo ticket para ver la imagen.',
  'history.noImageTooltip': 'No hay imagen disponible para este ticket'
}
