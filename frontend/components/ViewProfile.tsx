...
export function ViewProfile() {
        ...
        <Card className="w-full max-w-md">
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <Button onClick={handleEditProfile} className="bg-gradient-to-r from-theme-500 to-theme-600 hover:from-theme-600 hover:to-theme-700">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-theme-50 via-theme-100 to-theme-200">
      {/* Header */}
      <header className="bg-white/80 backdrop-blur-sm shadow-sm border-b border-theme-200/50">
        <div className="w-full mx-auto px-2 sm:px-4 lg:px-6">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-theme-800">My Profile</h1>
                <p className="text-sm text-theme-600">View your company and tax information</p>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center space-x-4">
                <div className="w-16 h-16 bg-gradient-to-r from-theme-400 to-theme-500 rounded-full flex items-center justify-center">
          ...
          <div className="flex justify-center pt-6">
            <Button
              onClick={handleEditProfile}
              size="lg"
              className="bg-gradient-to-r from-theme-500 to-theme-600 hover:from-theme-600 hover:to-theme-700 px-8"
            >
