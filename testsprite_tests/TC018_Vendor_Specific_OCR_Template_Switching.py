...
async def run_test():
    ...
    try:
        ...
        # Click on login link to access the login page for authentication.
        ...
        # Clear email field, input valid email 'GAMAN@example.com', input password, then submit login form.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div[2]/div/div[2]/form/div/input').nth(0)
        ...
        assert False, 'Test plan execution failed: OCR processing engine did not detect vendor or apply extraction template correctly.'
