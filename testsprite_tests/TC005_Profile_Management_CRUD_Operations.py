...
async def run_test():
    ...
    try:
        ...
        # Clear the email input, enter a valid email format for user GAMAN, then input password and click login.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div[2]/div/div[2]/form/div/input').nth(0)
        ...
        # Try to reload the page to reset the login state or check for any network/API errors. If login still fails, report the issue.
